    ...
    <Box>
        <Accordion>
                ...
                <AccordionDetails>
                    ...
                    <Typography variant='body1' fontWeight={'bold'}>Sunday </Typography><Typography variant='body2'>{ business && business.schedule.Sunday.start ?  DateTime.fromFormat(business.schedule.Sunday.start,'HH:mm').toFormat('h:mm a')  + "-" + DateTime.fromFormat(business.schedule.Sunday.end,'HH:mm').toFormat('h:mm a'): 'Off' }</Typography>
                    <Typography variant='body1' fontWeight={'bold'}>Monday </Typography> <Typography variant='body2'>{ business && business.schedule.Monday.start ? DateTime.fromFormat(business.schedule.Monday.start,'HH:mm').toFormat('h:mm a')  + "-" + DateTime.fromFormat(business.schedule.Monday.end ,'HH:mm').toFormat('h:mm a' ): 'Off'}</Typography>
                    <Typography variant='body1' fontWeight={'bold'}>Tuesday </Typography>: <Typography variant='body2'>{ business && business.schedule.Tuesday.start ? DateTime.fromFormat(business.schedule.Tuesday.start,'HH:mm').toFormat('h:mm a')  + "-" + DateTime.fromFormat(business.schedule.Tuesday.end,'HH:mm').toFormat('h:mm a') : 'Off'}</Typography>
                    <Typography variant='body1' fontWeight={'bold'}>Wednesday </Typography>: <Typography variant='body2'>{ business && business.schedule.Wednesday.start ? DateTime.fromFormat(business.schedule.Wednesday.start,'HH:mm').toFormat('h:mm a')  + "-" + DateTime.fromFormat(business.schedule.Wednesday.end,'HH:mm').toFormat('h:mm a'): 'Off'}</Typography>
                    <Typography variant='body1' fontWeight={'bold'}>Thursday </Typography>: <Typography variant='body2'>{ business && business.schedule.Thursday.start ? DateTime.fromFormat(business.schedule.Thursday.start,'HH:mm').toFormat('h:mm a')  + "-" +DateTime.fromFormat( business.schedule.Thursday.end,'HH:mm').toFormat('h:mm a'): 'Off'}</Typography>
                    <Typography variant='body1' fontWeight={'bold'}>Friday </Typography>: <Typography variant='body2'>{ business && business.schedule.Friday.start ? DateTime.fromFormat(business.schedule.Friday.start,'HH:mm').toFormat('h:mm a') + "-" + DateTime.fromFormat(business.schedule.Friday.end,'HH:mm').toFormat('h:mm a'): 'Off'}</Typography>
                    <Typography variant='body1' fontWeight={'bold'}>Saturday </Typography>: <Typography variant='body2'>{ business && business.schedule.Saturday.start ? DateTime.fromFormat(business.schedule.Saturday.start,'HH:mm').toFormat('h:mm a')  + "-" + DateTime.fromFormat(business.schedule.Saturday.end ,'HH:mm').toFormat('h:mm a'): 'Off'}</Typography>
                </AccordionDetails>
            </Accordion>
